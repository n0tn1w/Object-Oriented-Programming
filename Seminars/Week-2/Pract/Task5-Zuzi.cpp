...
//     WriteIntoFile(subjects, 2);
//     Table* t = ReadFromFile();
//     PrintTable(t);

//     Subject subjects = {Category::M, 3, 4, 1, "FP"};
//     AddSubject(t, *subjects);
//     uint16_t id = 3;
//     DeleteSubject(t, id);
//     uint16_t findId = 1;
//     Subject* subjectById = FindSubjectById(t, id);
//     Subject* subjectsByCategory = FindSubjectsByCategory(t, Category::OKN);
//     size_t minC = 1, maxC = 10;
//     Subject* subjecysByCredits = FindSubjectsByCredits(t, minC, maxC);

//     WriteIntoFile(t->subjects, t->len);
...
// Subject subjects[2] = {
//         {Category::OKN, 1, 6, 2, "Zistemno"},
//         {Category::PM, 2, 7, 5, "Sluchaini procesi"}
//     };